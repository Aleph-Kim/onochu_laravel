...
<div class="md:px-5">
                ...
                <div class="song-box flex justify-between h-[110px] w-full p-5 transition-all hover:rounded-[10px] hover:bg-[#e5e5e5] [&:not(:last-child)]:border-b [&:not(:last-child)]:border-[#e5e5e5]">
                    <div class="flex flex-1 min-w-0 overflow-hidden">
                        <span class="w-[70px] mr-[10px] flex-shrink-0 max-sm:mr-0">
                            <img src="{{ $song['album']['img_url'] }}?/dims/resize/350x350/quality/90" alt="" class="h-full rounded-[3px]">
                        </span>
                        <div class="max-w-[75%] px-[10px] flex flex-col justify-around">
                            <div class="text-primary overflow-hidden text-ellipsis whitespace-nowrap">{{ $song['song']['title'] }}</div>
                            <div class="overflow-hidden text-ellipsis whitespace-nowrap text-sm max-sm:text-[14px] text-[#555]">
                                <span>
    ...
    @else
        <div class="mt-[50px] text-center text-[#686868]">
            <svg viewBox="0 0 24 24" class="fill-[#686868] w-24 h-24 mx-auto"><g><path d="M20.87,20.17l-5.59-5.59C16.35,13.35,17,11.75,17,10c0-3.87-3.13-7-7-7s-7,3.13-7,7s3.13,7,7,7c1.75,0,3.35-0.65,4.58-1.71 l5.59,5.59L20.87,20.17z M10,16c-3.31,0-6-2.69-6-6s2.69-6,6-6s6,2.69,6,6S13.31,16,10,16z"></path></g></svg>
            <div class="my-[30px] text-[1.3em]"><span class="text-primary">{{ $keyword }}</span>에 대한 검색결과가 없습니다.</div>
