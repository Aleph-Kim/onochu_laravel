...
<div class="pt-10 px-[30px] pb-[60px]">
    ...
    <div class="my-5 mb-[35px] flex justify-evenly lg:justify-end items-center gap-5">
        <div class="custom-selector relative w-[120px]" id="albumTypeFilter">
            <div class="selected-option py-2 px-3.5 bg-bg border-[1.5px] border-[#ebebf0] rounded-full cursor-pointer text-[13px] font-medium text-center transition-[background,border-color] duration-200 hover:bg-[#ebebf0] hover:border-[#d5d5e0]">전체</div>
            <div class="options hidden absolute top-[calc(100%+4px)] left-0 w-full bg-white border-[1.5px] border-[#ebebf0] rounded-[14px] shadow-[0_8px_24px_rgba(0,0,0,0.08)] z-10 p-1 overflow-hidden">
                <div class="option py-2.5 px-4 text-sm cursor-pointer transition-[background] duration-[150ms] rounded-lg hover:bg-[#f0f0fa]" data-type="all">전체</div>
                <div class="option py-2.5 px-4 text-sm cursor-pointer transition-[background] duration-[150ms] rounded-lg hover:bg-[#f0f0fa]" data-type="정규/미니">정규/미니</div>
                <div class="option py-2.5 px-4 text-sm cursor-pointer transition-[background] duration-[150ms] rounded-lg hover:bg-[#f0f0fa]" data-type="싱글">싱글</div>
                <div class="option py-2.5 px-4 text-sm cursor-pointer transition-[background] duration-[150ms] rounded-lg hover:bg-[#f0f0fa]" data-type="참여">참여</div>
            </div>
        </div>
        ...
        <button id="albumSearchIconBtn" class="hidden max-sm:flex items-center justify-center w-9 h-9 shrink-0" onclick="showAlbumSearch()">
            <svg viewBox="0 0 24 24" class="w-5 h-5 fill-[#b0b0c0]"><g><path d="M20.87,20.17l-5.59-5.59C16.35,13.35,17,11.75,17,10c0-3.87-3.13-7-7-7s-7,3.13-7,7s3.13,7,7,7c1.75,0,3.35-0.65,4.58-1.71 l5.59,5.59L20.87,20.17z M10,16c-3.31,0-6-2.69-6-6s2.69-6,6-6s6,2.69,6,6S13.31,16,10,16z"></path></g></svg>
        </button>
        <div class="flex-1 max-w-[200px] flex items-center gap-2 max-sm:hidden" id="albumSearchWrap">
            <button id="albumSearchHideBtn" class="hidden w-[26px] h-[26px] shrink-0" onclick="hideAlbumSearch()">
                <svg viewBox="0 0 24 24" class="fill-[#b0b0c0]"><g><path d="M21,11v1H5.64l6.72,6.72l-0.71,0.71L3.72,11.5l7.92-7.92l0.71,0.71L5.64,11H21z"></path></g></svg>
            </button>
